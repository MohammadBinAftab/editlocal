...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', url: '/', siteName, title: 'EditLocal — Free Video & Photo Tools, No Upload', description: siteTagline, locale: 'en_US' },
  twitter: { card: 'summary', title: 'EditLocal — Free Private Media Tools', description: siteTagline },
  ...
  return (
    <html lang="en">
      <body>
        ...
        {children}
        <footer className="border-t border-border bg-[#17151f] px-5 py-10 text-white">
