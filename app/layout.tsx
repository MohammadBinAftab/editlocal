...
export const metadata: Metadata = {
  ...
  description: 'Free online video and photo editor without watermark. Reframe, freeze, reverse, caption, add voiceovers, remove green screens, and edit locally.',
  keywords: ['free video tools', 'private video editor', 'freeze frame video', 'reverse video online', 'add captions to video', 'add voiceover to video', 'green screen remover', 'local image tools'],
